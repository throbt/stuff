...
$(document).ready(function() {
  ...
  $('.saveHome').live('click',function() {
    ...
    if(mainId == '') {
      ...
      $.get(
        '/admin_ajax/saveHomeItem',
        {'id':mainId,'data':dataSave},
        function(resp) {
          window.location.href = '/node/nodetype/home';
        }
      );
    }
    return false;
...
<ul class="breadcrumb">
  ...
  <li>
    <a href="/node/nodetype/home">Home</a>
    <span class="divider">/</span>
  </li>
  <li class="active">
...
<div class="row show-grid">
  <div class="span12">
    <div class="span6">
        <a id="" class="btn btn-primary saveHome" rel="" href="" type="submit">Ment</a>
    </div>
  </div>
</div>  
