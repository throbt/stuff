    ...
    if(thisContent.length != 0) {
      for(var i = 0,l = thisContent.length; i < l; i += 2) {
        $$.create({
          ...
          arr   : [{
            type  : 'div',
            cls   : 'content_box',
            html  : ['<a href="',decodeURIComponent(thisContent[i]['link']).replace(/\+/g, ''),'" class="headline">',decodeURIComponent(thisContent[i]['title']).replace(/\+/g, ' '),'</a><p class="">',decodeURIComponent(thisContent[i]['body']).replace(/\+/g, ' '),'</p>'].join('')
          },{
            type  : 'div',
            cls   : 'content_box',
            html  : (typeof thisContent[i+1] != 'undefined' ? ['<a href="',decodeURIComponent(thisContent[i+1]['link']).replace(/\+/g, ''),'" class="headline">',decodeURIComponent(thisContent[i+1]['title']).replace(/\+/g, ' '),'</a><p class="">',decodeURIComponent(thisContent[i+1]['body']).replace(/\+/g, ' '),'</p>'].join('') : '')
          }]
      ...
      $$.create({
          ...
          arr   : [{
            type  : 'div',
            cls   : 'content_box',
            html  : ['<a class="headline">Nincs találat</a>'].join('')
          }]
        },$$.cache.content_box_wrapper);
    }
  },
