<div class="control-group <?php echo isset($this->var['class']) ? $this->var['class'] : ''; ?>" style="">
  <label for="<?php echo isset($this->var['name']) ? $this->var['name'] : ''; ?>"><?php echo isset($this->var['label']) ? $this->var['label'] : ''; ?></label>
  <div class="controls" style="float:left;">
    <select id="<?php echo isset($this->var['id']) ? $this->var['id'] : ''; ?>" name="<?php echo isset($this->var['name']) ? $this->var['id'] : ''; ?>" class="<?php echo isset($this->var['class']) ? $this->var['class'] : ''; ?>">


      <?php print_r( $this->var['options'] );
        // array 
