        ...
        arr   : [{
          ...
          arr   : [{
            ...
            html  : [
              ...
              ['<p>'].join(''),
              ['<a class="sidebarLink_active" href="/email">Email</a>'].join(''),
              ['</p>'].join(''),
...
//		},$$.cache.contact_body);
		...
		$('#phone').html(evoline.cfg['translate']['subject']);
...
//    },$$.cache.main_menu_footer);
  ...
  finishLayoutSetup: function() {
    ...
    $($$.cache.splicing).css({
      ...
      height      : evoline.dimensions['height']-660,
      paddingTop  : 250
    });
...
//    },$$.cache.subpage_content_wrapper);
    ...
    $$.create({
      ...
      arr   : [{
        type  : 'div',
        id    : 'newsletter_form',
        style : 'position:absolute;width:100%;height:320px;left:0px;top:6px;',
        arr   : [{
          type  : 'form',
          id    : 'cv',
          action: '/content/menu/email_add',
          method: 'post',
          arr   : [{
            type  : 'div',
            ...
            type  : 'div',
            id    : 'submit_wrapper',
            style : 'height:36px;margin-top:3px;padding-top:0px',
            cls   : 'field_wrapper_cv',
            html  : [
