<div class="clearfix <?php echo isset($this->var['class']) ? $this->var['class'] : ''; ?>">
	...
	<div class="checkbox">
	  <input type="checkbox" id="<?php echo isset($this->var['id']) ? $this->var['id'] : ''; ?>" class="input  <?php echo isset($this->var['class']) ? $this->var['class'] : ''; ?>" name="<?php echo isset($this->var['name']) ? $this->var['name'] : ''; ?>" />
  </div>
</div>
