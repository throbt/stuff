...
<div class="row show-grid">
  <div class="span12">
    <div class="span2">
      <a id="sbm" class="btn btn-primary" href="/node/add/<?php echo $this->var['type']; ?>" type="submit">Új <?php echo $this->var['type']; ?></a>
    </div>
  </div>
  <div class="span12">
  &nbsp;
...
<div class="row show-grid">
    ...
    <?php foreach($this->var['data'] as $node): ?>
      <div class="span12">
        ...
        <div class="span1">
          <a class="btn btn-primary delete" rel="<?php echo $node['nid']; ?>">Törlés</a>
        </div>
      </div>
      <br /><br /><br />
    <?php endforeach; ?>
