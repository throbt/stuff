...
$(document).ready(function() {
  ...
  $('.updateGallery').live('click',function() {
...
<div class="row show-grid">
  <div class="span12">
    <div class="span6">
        <a id="" class="btn btn-primary updateGallery" rel="" href="" type="submit">Ment</a>
    </div>
  </div>
</div>  
