  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a target="_blank" href="/<?php echo $data['thisorder']; ?>" id="sbm" class="btn btn-primary save" type="submit" rel="1">link</a>
        </td>

        <td id="params<?php echo $data['id']; ?>" class="editable"><?php echo $data['params']; ?></td>

        <td>
          <a target="_blank" href="/<?php echo $data['params']; ?>" id="sbm" class="btn btn-primary save" type="submit" rel="1">link</a>
        </td>
        ...
        <td>
          <button id="sbm" class="btn btn-primary del" type="submit" rel="<?php echo $data['id']; ?>">Töröl</button>
        </td>
