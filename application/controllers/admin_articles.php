...
class Admin_articles_controller extends Nodecontroller {
  ...
  public function show() {
    $res = $this->showAction('articles');  print_r($res);
  }

  // public function update() {
  //   $res = $this->updateAction('articles');  print_r($res);
  // }
